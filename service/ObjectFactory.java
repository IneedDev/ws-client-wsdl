...
public class ObjectFactory {
    ...
    private final static QName _F2CResponse_QNAME = new QName("http://service/", "f2cResponse");
    private final static QName _C2F_QNAME = new QName("http://service/", "c2f");
    private final static QName _C2FResponse_QNAME = new QName("http://service/", "c2fResponse");
    private final static QName _F2C_QNAME = new QName("http://service/", "f2c");
    private final static QName _In2CmResponse_QNAME = new QName("http://service/", "in2cmResponse");
    private final static QName _In2Cm_QNAME = new QName("http://service/", "in2cm");
    private final static QName _Cm2InResponse_QNAME = new QName("http://service/", "cm2inResponse");
    private final static QName _Cm2In_QNAME = new QName("http://service/", "cm2in");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "f2cResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "c2f")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "c2fResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "f2c")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "in2cmResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "in2cm")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "cm2inResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "cm2in")
