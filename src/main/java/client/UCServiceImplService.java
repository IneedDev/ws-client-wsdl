    ...
    extends Service
{
    ...
    public client.UC getUCServiceImplPort() {
        return super.getPort(new QName("http://service/", "UCServiceImplPort"), client.UC.class);
    }
     ...
     */
    @WebEndpoint(name = "UCServiceImplPort")
    public client.UC getUCServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "UCServiceImplPort"), client.UC.class, features);
    }
